...
def home():
    ...
    st.markdown("***")
    st.markdown("<h3 style='text-align: center; color: black;'>Análise de Carteira</h3>", unsafe_allow_html=True)
    st.markdown("")
    col1, col2, col3, col4, col5  = st.columns([0.1,1,0.01,1,0.1])
    col2.image('./imagens/video_analise_carteira.gif')
    col4.markdown("")
    col4.markdown("<h4 style='text-align: left; color: black;'>- Inserir os ativos da sua carteira.</h4>", unsafe_allow_html=True)
    col4.markdown("<h4 style='text-align: left; color: black;'>- Calcular o BETA e ver as informações sobre Hedge.</h4>", unsafe_allow_html=True)
    col4.markdown("<h4 style='text-align: left; color: black;'>- Analisar as correlações entre os ativos da sua carteira e principais indices.</h4>", unsafe_allow_html=True)
    col4.markdown("<h4 style='text-align: left; color: black;'>- Verificar a distribuição Setorial.</h4>", unsafe_allow_html=True)
    col4.markdown("<h4 style='text-align: left; color: black;'>- Análise de Risco x Retorno de cada Ativo.</h4>", unsafe_allow_html=True)
    col4.markdown("<h4 style='text-align: left; color: black;'>- Simulação da Rentabilidade da sua Carteira.</h4>", unsafe_allow_html=True)
    st.markdown("***")
    st.markdown("<h3 style='text-align: center; color: black;'>Correlações</h3>", unsafe_allow_html=True)
    st.markdown("")
    col1, col2, col3, col4, col5  = st.columns([0.1,1,0.01,1,0.1])
    ...
    col4.markdown("")
    col4.markdown("")
    col4.markdown("<h4 style='text-align: left; color: black;'>- Verificar as correlações entre os ativos.</h4>", unsafe_allow_html=True)
    col4.markdown("<h4 style='text-align: left; color: black;'>- Comparar a correlação com os principais indices.</h4>", unsafe_allow_html=True)
    col4.markdown("<h4 style='text-align: left; color: black;'>- Analisar a correlação no tempo.</h4>", unsafe_allow_html=True)
    st.markdown("***")
    st.markdown("<h3 style='text-align: center; color: black;'>Sazonalidade do Mercado</h3>", unsafe_allow_html=True)
    st.markdown("")
    col1, col2, col3, col4, col5  = st.columns([0.1,1,0.01,1,0.1])
    ...
    col4.markdown("")
    col4.markdown("")
    col4.markdown("<h4 style='text-align: left; color: black;'>- Analisar a sazonalidade de um deteminado ativo.</h4>", unsafe_allow_html=True)
    col4.markdown("<h4 style='text-align: left; color: black;'>- Ações e Indices Brasileiros e dos Estados Unidos.</h4>", unsafe_allow_html=True)
    col4.markdown("<h4 style='text-align: left; color: black;'>- Verificar a rentabilidade mensal.</h4>", unsafe_allow_html=True)
    col4.markdown("<h4 style='text-align: left; color: black;'>- Identificar padrões de comportamento ao longo do ano.</h4>", unsafe_allow_html=True)
    st.markdown("***")
    st.markdown("<h3 style='text-align: center; color: black;'>Raio-X do Mercado</h3>", unsafe_allow_html=True)
    st.markdown("")
    col1, col2, col3, col4, col5  = st.columns([0.1,1,0.01,1,0.1])
    ...
    col4.markdown("")
    col4.markdown("")
    col4.markdown("<h4 style='text-align: left; color: black;'>- Verificar como estão as bolsas pelo mundo em tempo real.</h4>", unsafe_allow_html=True)
    col4.markdown("<h4 style='text-align: left; color: black;'>- Dados e informações das principais bolsas.</h4>", unsafe_allow_html=True)

...
def home():
    ...
    st.markdown("<h3 style='text-align: center; color: black;'>Bem Vindo ao Análise Quant</h3>", unsafe_allow_html=True)
    st.markdown("<h4 style='text-align: center; color: black;'>Uma plataforma de análises e estudos quantitativos do mercado financeiro.</h4>", unsafe_allow_html=True)
    st.markdown("<h4 style='text-align: center; color: black;'>Veja o que você pode fazer:</h4>", unsafe_allow_html=True)
    st.markdown("***")
    st.markdown("<h5 style='text-align: center; color: black;'>Análise de Carteira</h5>", unsafe_allow_html=True)
    st.markdown("")
    col1, col2, col3, col4, col5  = st.columns([0.1,1,0.01,1,0.1])
    col2.image('./imagens/video_analise_carteira.gif')
    col4.markdown("")
    col4.markdown("<h6 style='text-align: left; color: black;'>- Inserir os ativos da sua carteira.</h6>", unsafe_allow_html=True)
    col4.markdown("<h6 style='text-align: left; color: black;'>- Calcular o BETA e ver as informações sobre Hedge.</h6>", unsafe_allow_html=True)
    col4.markdown("<h6 style='text-align: left; color: black;'>- Analisar as correlações entre os ativos da sua carteira e principais indices.</h6>", unsafe_allow_html=True)
    col4.markdown("<h6 style='text-align: left; color: black;'>- Verificar a distribuição Setorial.</h6>", unsafe_allow_html=True)
    col4.markdown("<h6 style='text-align: left; color: black;'>- Análise de Risco x Retorno de cada Ativo.</h6>", unsafe_allow_html=True)
    col4.markdown("<h6 style='text-align: left; color: black;'>- Simulação da Rentabilidade da sua Carteira.</h6>", unsafe_allow_html=True)
    st.markdown("***")
    st.markdown("<h5 style='text-align: center; color: black;'>Correlações</h5>", unsafe_allow_html=True)
    st.markdown("")
    col1, col2, col3, col4, col5  = st.columns([0.1,1,0.01,1,0.1])
    ...
    col4.markdown("")
    col4.markdown("")
    col4.markdown("<h6 style='text-align: left; color: black;'>- Verificar as correlações entre os ativos.</h6>", unsafe_allow_html=True)
    col4.markdown("<h6 style='text-align: left; color: black;'>- Comparar a correlação com os principais indices.</h6>", unsafe_allow_html=True)
    col4.markdown("<h6 style='text-align: left; color: black;'>- Analisar a correlação no tempo.</h6>", unsafe_allow_html=True)
    st.markdown("***")
    st.markdown("<h5 style='text-align: center; color: black;'>Sazonalidade do Mercado</h5>", unsafe_allow_html=True)
    st.markdown("")
    col1, col2, col3, col4, col5  = st.columns([0.1,1,0.01,1,0.1])
    ...
    col4.markdown("")
    col4.markdown("")
    col4.markdown("<h6 style='text-align: left; color: black;'>- Analisar a sazonalidade de um deteminado ativo.</h6>", unsafe_allow_html=True)
    col4.markdown("<h6 style='text-align: left; color: black;'>- Ações e Indices Brasileiros e dos Estados Unidos.</h6>", unsafe_allow_html=True)
    col4.markdown("<h6 style='text-align: left; color: black;'>- Verificar a rentabilidade mensal.</h6>", unsafe_allow_html=True)
    col4.markdown("<h6 style='text-align: left; color: black;'>- Identificar padrões de comportamento ao longo do ano.</h6>", unsafe_allow_html=True)
    st.markdown("***")
    st.markdown("<h5 style='text-align: center; color: black;'>Raio-X do Mercado</h5>", unsafe_allow_html=True)
    st.markdown("")
    col1, col2, col3, col4, col5  = st.columns([0.1,1,0.01,1,0.1])
    ...
    col4.markdown("")
    col4.markdown("")
    col4.markdown("<h6 style='text-align: left; color: black;'>- Verificar como estão as bolsas pelo mundo em tempo real.</h6>", unsafe_allow_html=True)
    col4.markdown("<h6 style='text-align: left; color: black;'>- Dados e informações das principais bolsas.</h6>", unsafe_allow_html=True)
